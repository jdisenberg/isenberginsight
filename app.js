(function () {
  ...
  const CLINICAL_SOURCES = [
    {
      ...
      items: [
        { label: "WHS Guidelines for the Treatment of Pressure Ulcers (2023 update)", url: "https://pubmed.ncbi.nlm.nih.gov/37970711/" },
        { label: "NPIAP/EPUAP/PPPIA International Pressure Injury Guidelines (2019)", url: "https://epuap.org/pu-guideline/" },
        { label: "IWGDF Offloading Guideline (2023) — non-removable knee-high device, Grade A recommendation", url: "https://iwgdfguidelines.org/wp-content/uploads/2023/07/IWGDF-2023-06-Offloading-Guideline.pdf" },
        { label: "IWGDF Wound Healing Interventions Guideline (2023)", url: "https://iwgdfguidelines.org/wp-content/uploads/2023/07/IWGDF-2023-07-Wound-Healing-Guideline.pdf" },
        { label: "IWGDF/IDSA Diabetes-Related Foot Infection Guideline (2023)", url: "https://www.idsociety.org/practice-guideline/diabetic-foot-infections/" },
        { label: "IWGDF Infection Guideline (2023) — avoid systemic antibiotics for clinically uninfected DFU", url: "https://iwgdfguidelines.org/wp-content/uploads/2023/07/IWGDF-2023-04-Infection-Guideline.pdf" },
        { label: "IWGDF PAD Guideline (2023) — 4-week <50% area reduction reassessment trigger", url: "https://iwgdfguidelines.org/wp-content/uploads/2023/07/IWGDF-2023-05-PAD-Guideline.pdf" },
        ...
        { label: "SVS/AVF Venous Leg Ulcer Guideline (PubMed record)", url: "https://pubmed.ncbi.nlm.nih.gov/24974070/" },
        { label: "ISBI Practice Guidelines for Burn Care 2016", url: "https://www.worldburn.org/resources/isbi-practice-guidelines-for-burn-care/" },
        ...
        { label: "EWMA/WUWHS Wound Infection and Biofilm Management Consensus 2016", url: "https://www.wuwhs2016.com/" },
      ],
    },
    {
      title: "Randomized Controlled Trials & Key Clinical Studies",
      items: [
        { label: "EVRA trial — early endovenous ablation in venous leg ulcers (PMID 31140402)", url: "https://pubmed.ncbi.nlm.nih.gov/31140402/" },
        { label: "SENATOR Trial — silicone foam for pressure injury prevention (Santamaria N, Int Wound J 2015, PMID 26333657)", url: "https://pubmed.ncbi.nlm.nih.gov/26333657/" },
        { label: "PIONEER I & II — adalimumab for moderate-to-severe hidradenitis suppurativa (Kimball AB, NEJM 2016, PMID 27518661)", url: "https://pubmed.ncbi.nlm.nih.gov/27518661/" },
        { label: "RAVE trial — rituximab vs cyclophosphamide for ANCA-associated vasculitis (Stone JH, NEJM 2010, PMID 20647199)", url: "https://pubmed.ncbi.nlm.nih.gov/20647199/" },
        { label: "OVIVA trial — oral vs IV antibiotics for bone and joint infections (Li HK, NEJM 2019, PMID 30699315)", url: "https://pubmed.ncbi.nlm.nih.gov/30699315/" },
        { label: "Marx RE — osteoradionecrosis: HBOT pathophysiology and RCT (J Oral Maxillofac Surg 1983, PMID 6225632)", url: "https://pubmed.ncbi.nlm.nih.gov/6225632/" },
        { label: "Delanian S et al. — regression of chronic radiotherapy damage with pentoxifylline + Vit E (J Clin Oncol 2003, PMID 12637469)", url: "https://pubmed.ncbi.nlm.nih.gov/12637469/" },
        { label: "Diggelmann HR et al. — hyaluronic acid gel vs Mepilex Lite for acute radiation dermatitis RCT (Int J Radiat Oncol Biol Phys 2010, PMID 20421149)", url: "https://pubmed.ncbi.nlm.nih.gov/20421149/" },
        { label: "Brocard A et al. — zinc gluconate for hidradenitis suppurativa, randomised prospective study (Dermatology 2007, PMID 17341870)", url: "https://pubmed.ncbi.nlm.nih.gov/17341870/" },
        { label: "Jemec GBE et al. — topical clindamycin vs systemic tetracycline in hidradenitis suppurativa RCT (Dermatology 1998, PMID 9568396)", url: "https://pubmed.ncbi.nlm.nih.gov/9568396/" },
        { label: "Hafner J et al. — Martorell hypertensive ischemic leg ulcer: pathophysiology and management (Dermatology 2010, PMID 20689247)", url: "https://pubmed.ncbi.nlm.nih.gov/20689247/" },
        { label: "Tawfick W et al. — Martorell hypertensive ischemic ulcer and hyperbaric oxygen (Eur J Vasc Endovasc Surg 2013, PMID 23290862)", url: "https://pubmed.ncbi.nlm.nih.gov/23290862/" },
        { label: "van Anholt RD et al. — arginine supplementation accelerates Stage 3/4 pressure injury healing (Clin Nutr 2010, PMID 20045569)", url: "https://pubmed.ncbi.nlm.nih.gov/20045569/" },
        { label: "Wieman TJ et al. — becaplermin gel for diabetic foot ulcers (Diabetes Care 1998, PMID 9571335)", url: "https://pubmed.ncbi.nlm.nih.gov/9571335/" },
        { label: "Zelen CM et al. — dehydrated human amnion/chorion membrane for DFU (J Wound Care 2014, PMID 24842571)", url: "https://pubmed.ncbi.nlm.nih.gov/24842571/" },
        { label: "Maverakis E et al. — pyoderma gangrenosum diagnostic criteria (JAMA Dermatol 2020, PMID 32459330)", url: "https://pubmed.ncbi.nlm.nih.gov/32459330/" },
        { label: "Murphy C et al. — biofilm and wound healing: TIMERS framework (J Wound Care 2020, PMID 32069139)", url: "https://pubmed.ncbi.nlm.nih.gov/32069139/" },
        { label: "Beeckman D et al. — structured skin care for incontinence-associated dermatitis prevention (J Wound Care 2015, PMID 26606512)", url: "https://pubmed.ncbi.nlm.nih.gov/26606512/" },
        { label: "Gardner SE et al. — wound culture technique comparison: Levine vs swab (Wound Repair Regen 2006, PMID 16674555)", url: "https://pubmed.ncbi.nlm.nih.gov/16674555/" },
        { label: "Lok C et al. — EMLA cream for VLU debridement pain reduction (J Am Acad Dermatol 1999, PMID 10069514)", url: "https://pubmed.ncbi.nlm.nih.gov/10069514/" },
        { label: "Gottrup F et al. — ibuprofen-releasing foam dressing for wound pain (J Wound Care 2007, PMID 17661787)", url: "https://pubmed.ncbi.nlm.nih.gov/17661787/" },
        { label: "Cutting KF et al. — betaine/PHMB (Prontosan) wound cleanser: evidence review (J Wound Care 2010, PMID 20539230)", url: "https://pubmed.ncbi.nlm.nih.gov/20539230/" },
        { label: "1% acetic acid in chronic wounds colonized with Pseudomonas aeruginosa — RCT (PMID 25851059)", url: "https://pubmed.ncbi.nlm.nih.gov/25851059/" },
      ],
    },
    {
      title: "Cochrane Reviews & Systematic Meta-Analyses",
      items: [
        { label: "Cochrane: compression bandages and stockings for venous leg ulcers (CD000265)", url: "https://www.cochrane.org/CD000265/WOUNDS_compression-bandages-and-stockings-to-help-the-healing-of-venous-leg-ulcers" },
        { label: "Cochrane: compression vs no compression for venous leg ulcers (CD013397)", url: "https://www.cochrane.org/evidence/CD013397_compression-bandages-or-stockings-versus-no-compression-treating-venous-leg-ulcers" },
        { label: "Cochrane: negative pressure wound therapy for pressure ulcers (CD011334)", url: "https://www.cochrane.org/CD011334/WOUNDS_negative-pressure-wound-therapy-treating-pressure-ulcers" },
        { label: "Cochrane: topical silver for treating infected wounds (CD005486)", url: "https://www.cochrane.org/CD005486/WOUNDS_topical-silver-for-treating-infected-wounds" },
        { label: "Cochrane: honey as a topical treatment for acute and chronic wounds (CD005083)", url: "https://www.cochrane.org/CD005083/WOUNDS_honey-as-a-topical-treatment-for-acute-and-chronic-wounds" },
        { label: "Cochrane: alginate dressings for pressure ulcers (CD011277)", url: "https://www.cochrane.org/evidence/CD011277_astfadh-az-pansmanhay-alzhynat-dr-drman-zkhmhay-fshary" },
        { label: "Cochrane: hyperbaric oxygen therapy for chronic wounds (CD004123)", url: "https://www.cochrane.org/evidence/CD004123_hyperbaric-oxygen-therapy-treating-chronic-wounds" },
        { label: "Cochrane: electrical stimulation for pressure ulcers (CD012196)", url: "https://www.cochrane.org/evidence/CD012196_electrical-stimulation-effective-treating-pressure-ulcers" },
        { label: "Cochrane: therapeutic ultrasound for venous leg ulcers (CD001180)", url: "https://www.cochrane.org/CD001180/WOUNDS_can-ultrasound-therapy-help-heal-venous-varicose-leg-ulcers-andor-improve-symptoms" },
        { label: "Cochrane: dressings for donor site wounds after split-thickness skin graft (CD001517, Ubbink DT 2013)", url: "https://www.cochrane.org/CD001517/WOUNDS_dressings-for-donor-site-wounds-after-split-thickness-skin-graft" },
        { label: "Jull AB et al. — pentoxifylline for venous leg ulcers: Cochrane systematic review (PMID 22972038)", url: "https://pubmed.ncbi.nlm.nih.gov/22972038/" },
        { label: "O'Meara S et al. — cadexomer iodine for chronic wounds: Cochrane systematic review (PMID 24771721)", url: "https://pubmed.ncbi.nlm.nih.gov/24771721/" },
      ],
    },
    {
      title: "Product References",
      items: [
        { label: "DailyMed: Santyl (collagenase) label — dosing, compatibility, and silver cautions", url: "https://dailymed.nlm.nih.gov/dailymed/lookup.cfm?setid=6b6fbfc6-98fa-46aa-88ef-ab00fbb08ffd" },
        { label: "XSONX Wound Hygiene System IFU", url: "https://xsonx.com/wp-content/uploads/2023/06/230607-XSONX-WOUND-HYGIENE-SYSTEM-IFU-Instructions-For-Use.pdf" },
        { label: "Arobella Qoustic Wound Therapy System brochure and indications", url: "https://arobella.com/wp-content/uploads/2024/12/0000334-Rev-J-04DEC2024-AR1000-QWTS-Brochure-Arobella-Medical.pdf" },
        { label: "Hydrofera Blue Classic IFU", url: "https://staging.hydrofera.com/content/uploads/2024/12/08-004-208-Hydrofera-Blue-Classic-IFU-Rev04.pdf" },
        { label: "MediHoney debridement brochure", url: "https://app.sales.integralife.com/advanced-wound-care/prepare/medihoney/brochures-sell-sheets/medihoney-debridement-brochure.pdf" },
        { label: "ConvaTec Aquacel Ag+ product instructions", url: "https://www.convatec.com/en-gb/advanced-wound-care/resources/product-instructions/aquacel-ag-dressings/" },
        { label: "ConvaTec Kaltostat alginate dressing page", url: "https://www.convatec.com/en-nz/products/advanced-wound-care/wound-type/pc-wound-pressure-ulcers-stage-1-2/kaltostat-alginate-calcium-sodium-dressing" },
        { label: "3M Promogran collagen matrix monograph", url: "https://multimedia.3m.com/mws/media/1897899O/3m-promogran-matrix-family-monograph.pdf" },
      ],
    },
    {
      title: "Educational & Reference Resources",
      items: [
        { label: "StatPearls: Wound Dressings", url: "https://www.ncbi.nlm.nih.gov/books/NBK470199/" },
        { label: "StatPearls: Wound Debridement", url: "https://www.ncbi.nlm.nih.gov/books/NBK507882/" },
        { label: "StatPearls: Dakin Solution", url: "https://www.ncbi.nlm.nih.gov/books/NBK507916/" },
        { label: "StatPearls: Wound Irrigation", url: "https://www.ncbi.nlm.nih.gov/books/NBK538522/" },
      ],
    },
  ];
  ...
  function initWoundAnalyzer() {
    ...
    function hideLoupe() {
      const lc = loupeCvs(); if (lc) lc.hidden = true;
    }
    ...
    function drawLoupe(clientX, clientY) {
      ...
      const lW = lc.width, lH = lc.height, half = lW / 2;
      const zoom = 3;
      /* touch point in image coords */
      const mcRect = mc.getBoundingClientRect();
      const ix = ((clientX - mcRect.left) * (canvW / mcRect.width)) / imgScale;
      const iy = ((clientY - mcRect.top)  * (canvH / mcRect.height)) / imgScale;
      /* source region: lW/zoom × lH/zoom centred on (ix, iy), clamped to image */
      const srcW = lW / zoom, srcH = lH / zoom;
      const srcX = Math.max(0, Math.min(photoW - srcW, ix - srcW / 2));
      const srcY = Math.max(0, Math.min(photoH - srcH, iy - srcH / 2));
      ...
      lCtx.beginPath();
      lCtx.moveTo(half, 6); lCtx.lineTo(half, lH - 6);
      lCtx.moveTo(6, half); lCtx.lineTo(lW - 6, half);
      lCtx.stroke();
      lCtx.fillStyle = "rgba(255,255,255,0.9)";
      lCtx.beginPath(); lCtx.arc(half, half, 2.5, 0, Math.PI * 2); lCtx.fill();
      lCtx.restore();
      /* border ring */
      lCtx.beginPath(); lCtx.arc(half, half, half - 1.5, 0, Math.PI * 2);
    ...
    function init() {
      ...
      const c = cvs();
      if (c) {
        /* step 2 ruler — mouse click; touch handled below with loupe */
  ...
  function init() {
    ...
    const loadRemoteAuditLog = async () => {
      ...
      const messages = {
        kv_not_configured: "⚠ Audit not yet connected — to see all users: Cloudflare dashboard → Pages → isenberginsight → Settings → Functions → KV namespace bindings → add binding named CICATRIX_AUDIT",
        not_deployed:      "⚠ Audit endpoint not found — confirm functions/audit.js is present and the Cloudflare Pages deployment completed",
